const Shimmer = () => {
  return (
    <>
      <div className=" bg-[#171a29] h-[344px] w-full flex flex-col pt-14">
        <div class="flex justify-center items-center w-[50px] h-[50px] mt-28 relative self-center">
          ...
          <div class="absolute -inset-4 border-4 border-t-transparent border-gray-900 rounded-full animate-spin "></div>
          <img
